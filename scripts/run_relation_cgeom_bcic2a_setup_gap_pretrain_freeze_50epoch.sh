...
python3 baseline_main.py \
  ...
  logging.run_group=bcic2a_setup_gap_disc_pretrain_freeze_50epoch \
  logging.experiment_name=relation_cgeom_bcic2a_setup_gap_disc_pretrain_freeze_50epoch \
  logging.tags='[relation_cgeom,bcic_2a,setup_gap_disc_pretrain,freeze_encoder,50epoch]'
